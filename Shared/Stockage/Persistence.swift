...
//    func maj(notification: NSNotification) {
//        print("\nNOTIFICATION D'ÉVOLUTION DU STOCKAGE DISTANT\n")
//    }
    
//    @objc func recevoirNotification(notification: Notification) {}
...
//            let context = conteneur.newBackgroundContext()
//            let context = self.conteneur.newBackgroundContext()
//
...
////
////                do {
////                    try items = context.fetch(Carte.obtenirLaListeFournieParLaRequete())
////                } catch {
////                    let nserror = error as NSError
...
//    func ajouterNouveauGroupe(nom: String) {
//        conteneur.viewContext.perform { [context = conteneur.viewContext] in
//        let groupe = Groupe(context: context)
//        groupe.id = UUID()
//        groupe.nom = nom
